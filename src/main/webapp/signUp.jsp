...
<body>
	...
	<div class="container d-flex align-items-center justify-content-center">
		<div class="sign-up-box">
			...
			<form id="signUpForm" method="post" action="/signupForm.do">
				<table class="sign-up-table table table-bordered">
					<tr>
						...
						<td>
							<div class="d-flex">
								...
								<button type="button" id="IdCheck" class="btn btn-success">중복확인</button>
								<br>
							</div>
					...
					<tr>
						...
						<td><input type="text" id="userName" name="userName"
							class="form-control" placeholder="이름(닉네임)을 입력하세요."></td>
					</tr>
					<tr>
				...
				<button type="submit" id="signUpBtn"
					class="btn btn-primary float-right mb-3 mr-3">회원가입</button>
			</form>
		</div>
	</div>
